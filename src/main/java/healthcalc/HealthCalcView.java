...
public class HealthCalcView {
    ...
    private void initialize() {
        ...
        calcularPesoIdealBtn.setBounds(33, 180, 138, 32);
        ...
        calcularBMRBtn.setBounds(181, 180, 104, 32);
        frame.getContentPane().add(calcularBMRBtn);
        
        borrarBtn = new JButton("Borrar");
        borrarBtn.setBounds(295, 180, 110, 29);
        frame.getContentPane().add(borrarBtn);
        
        JLabel lblResultado = new JLabel("Resultado");
        lblResultado.setBounds(33, 250, 100, 14);
        frame.getContentPane().add(lblResultado);

        resultadoTB = new JTextField();
        resultadoTB.setBounds(112, 250, 200, 20); 
